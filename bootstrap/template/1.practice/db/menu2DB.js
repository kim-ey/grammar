...
let item0TagList = []
// 사이드메뉴
let sideItemName0List = []
let sideItemName1List = []
let sideItemHref1List = []
let sideItemContent1List = []
let sideItemName2List = []
let sideItemHref2List = []
let sideItemContent2List = []
// 사이드배너
let sideBannerList = []
let sideBannerHrefList = []
